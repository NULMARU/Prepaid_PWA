...
소규모 음식점은 단체·직원 식대를 **선입금(선금)** 으로 받는다. 구청·시청 같은 공공기관 부서가 "이번 달 우리 과 12명 90,000원씩"을 계좌로 이체하고, 직원들이 그 잔액으로 밥을 먹는다. 회사·개인 단골도 같은 방식으로 미리 맡긴다.
...
**밥장부의 답**: 명단은 담당자 **브라우저에서 암호화**되어 그 음식점 폰에서만 열린다. 잔액은 **음식점 기기 안에만** 있고 서버는 내용을 모른다. 돈은 여전히 **기관 ↔ 음식점 계좌 이체**이며 운영자는 자금에 손대지 않는다. 그래서 **완전 무료**로 운영할 수 있다.
...
- **결제 없음** — 운영자는 자금을 수수·보관·이체·정산하지 않는다.
